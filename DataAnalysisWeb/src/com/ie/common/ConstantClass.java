...
//	public final static String UPLOAD_URL_BASE = "../webapps/hskkw-uploads/";  
    ...
    String DEBUG_MULITCARPICTURE="showMulitPictures";//显示车位 图片
    ...
    String DEBUG_RESTART_VIDEO = "reStartVideo";//重新启动视频探测器
    String DEBUG_READ_SET_KU_PARMER = "readSetKuPar";//  读取和更改识别库参数
    String DEBUG_READ_SET_VIDEO_PARMER = "readSetVideoPar";//  读取和更改单个摄像头的拍照参数
    
    String DEBUG_READ_SET_CAR_CYCLE = "readSetCarCycle";//  读取和更改单个摄像头的拍照参数
    //条屏
...
//	public static int LIMIT = Integer.parseInt(ParseXML.getProps().getProperty("LIMIT"));
//	public static String DB_TYPE = ParseXML.getProps().getProperty("DB_TYPE");
//	public static String MAP_DIR = ParseXML.getProps().getProperty("MAP_DIR");
